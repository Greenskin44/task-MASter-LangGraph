...
from graphs.research.state_research import Summary
from graphs.research.prompts import summarize_webpage_prompt
...
def get_today_str() -> str:
    ...
    # %d gives zero-padded day (01-31), which works on all platforms
